...
class ExpoBuild extends _command.Command {
  ...
  async run() {
    ...
    const child = (0, _child_process.spawn)((0, _fromRoot.default)('./node_modules/.bin/expo-cli'), ['build:android', '--config', _cliCore.Utils.fromProjectRoot(appJsonPath)], {
      shell: true,
      env: process.env,
      stdio: 'inherit'
...
(0, _defineProperty2.default)(ExpoBuild, "description", 'creates a build for android.');
(0, _defineProperty2.default)(ExpoBuild, "examples", [`$ bluebase expo:build:android`]);
