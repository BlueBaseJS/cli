...
_See code: [src/commands/web/build.ts](https://github.com/BlueBaseJS/cli/blob/v0.0.21/src/commands/web/build.ts)_
...
_See code: [src/commands/web/init.ts](https://github.com/BlueBaseJS/cli/blob/v0.0.21/src/commands/web/init.ts)_
...
_See code: [src/commands/web/start.ts](https://github.com/BlueBaseJS/cli/blob/v0.0.21/src/commands/web/start.ts)_
<!-- commandsstop -->
