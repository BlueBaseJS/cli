...
export default function withServiceWorker(webpackConfig, bundleConfig) {
	...
	// console.log('###################33333', path.resolve(__dirname,'../../../', 'index.ntml'));
	// console.log('///////////////', path.join(__dirname, '/index.html'));
	// console.log('#################333333333', path.resolve(__dirname,'../../../../' , 'web/index.prod.html'))
	...
	const offlineSettings = {
		...
		//         cur,
		//       );
		//       console.log('publicAssetPathGlob', publicAssetPathGlob, acc);
	...
	// console.log('offlineSettings',offlineSettings);
	webpackConfig.plugins.push(new OfflinePlugin(offlineSettings), );
